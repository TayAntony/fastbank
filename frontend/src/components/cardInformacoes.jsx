function CardInformacoes() {
    return ( 
    <>
    <div className=" bg-gradient-to-r from-[#B455FF] to-[#FF5A5A] xs:flex xs:flex-row p-8 justify-around items-center rounded-xl xs:mx-24 flex flex-col gap-1 shadow-[0_20px_15px_-10px_rgba(0,0,0,0.4)] border-white border-[1px] border-solid">
