function CardInformacoes() {
    return ( 
    <>
    <div className=" bg-gradient-to-r from-[#B455FF] to-[#FF5A5A] xs:flex xs:flex-row p-6  justify-around items-center rounded-xl xs:mx-24 flex flex-col gap-12 z-[999]  top-3/4">
